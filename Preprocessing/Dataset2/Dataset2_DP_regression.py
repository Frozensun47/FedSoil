...
X_train, X_val, y_train, y_val = train_test_split(df[['VWC']], df[['DP']],test_size = 0.2,shuffle=False)
...
df2=pd.read_csv("data\Dataset_2_preprocessing\Dataset2_unprocessed_1_1.csv")

to_predict = df2[['VWC']]

y2_prediction =  regressor.predict(to_predict)
y2_prediction

df2['DP']=y2_prediction

df2.to_csv("data\Dataset_2_preprocessing\Dataset2_unprocessed_1_2.csv",index=False)
